...
static int __pyx_f_3src_6recsys_3mrr__compare(const void *, const void *); /*proto*/
...
static PyObject *__pyx_pf_3src_6recsys_3mrr_mrr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_preds, __Pyx_memviewslice __pyx_v_labels, __Pyx_memviewslice __pyx_v_group_lengths); /* proto */
...
static int __pyx_f_3src_6recsys_3mrr__compare(const void *__pyx_v_a, const void *__pyx_v_b) {
 ...
 *     if v >= 0: return -1             # <<<<<<<<<<<<<<
 * 
 * def mrr(np.float64_t[:] preds, np.int64_t[:] labels, np.int64_t[:] group_lengths):
 */
  __pyx_t_1 = ((__pyx_v_v >= 0.0) != 0);
  if (__pyx_t_1) {
    __pyx_r = -1;
...
/* Python wrapper */
static PyObject *__pyx_pw_3src_6recsys_3mrr_1mrr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_3src_6recsys_3mrr_1mrr = {"mrr", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3src_6recsys_3mrr_1mrr, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3src_6recsys_3mrr_1mrr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("mrr (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_preds,&__pyx_n_s_labels,&__pyx_n_s_group_lengths,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_labels)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("mrr", 1, 3, 3, 1); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_group_lengths)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mrr", 1, 3, 3, 2); __PYX_ERR(0, 25, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "mrr") < 0)) __PYX_ERR(0, 25, __pyx_L3_error)
      }
    ...
    __pyx_v_preds = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_preds.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_labels = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_int64_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_labels.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
  ...
  __Pyx_RaiseArgtupleInvalid("mrr", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("src.recsys.mrr.mrr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3src_6recsys_3mrr_mrr(__pyx_self, __pyx_v_preds, __pyx_v_labels, __pyx_v_group_lengths);
...
static PyObject *__pyx_pf_3src_6recsys_3mrr_mrr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_preds, __Pyx_memviewslice __pyx_v_labels, __Pyx_memviewslice __pyx_v_group_lengths) {
  int __pyx_v_i;
  ...
  __Pyx_RefNannySetupContext("mrr", 0);
 ...
 *         j = i + g
 */
  __pyx_t_1 = (__pyx_v_group_lengths.shape[0]);
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_n = __pyx_t_3;

    /* "src/recsys/mrr.pyx":33
 * 
 *     for n in range(group_lengths.shape[0]):
 *         g = group_lengths[n]             # <<<<<<<<<<<<<<
 *         j = i + g
 ...
 */
  ...
  __pyx_t_11 = PyFloat_FromDouble((__pyx_v_mrrsum / __pyx_v_n_groups)); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 50, __pyx_L1_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_mrr, __pyx_k_mrr, sizeof(__pyx_k_mrr), 0, 0, 1, 1},
 ...
 *     cdef float mrrsum = 0
 */
  __pyx_tuple__26 = PyTuple_Pack(12, __pyx_n_s_preds, __pyx_n_s_labels, __pyx_n_s_group_lengths, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_g, __pyx_n_s_m, __pyx_n_s_n, __pyx_n_s_mrrsum, __pyx_n_s_n_groups, __pyx_n_s_order_struct); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(3, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_mrr_pyx, __pyx_n_s_mrr, 25, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 *     cdef float mrrsum = 0
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3src_6recsys_3mrr_1mrr, NULL, __pyx_n_s_src_recsys_mrr); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_mrr, __pyx_t_1) < 0) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
