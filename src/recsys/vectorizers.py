...
('clickout_counter_vs_impression_counter_mean_first_3_vs_item',False),
('top_7_impression_counter_min_first_3_vs_item',False),
('top_7_impression_counter_next_2_vs_item',False),
('top_7_impression_counter_rank_norm_before',False),
('clickout_counter_mean_after_vs_item',False),
('clickout_counter_vs_interaction_counter_min_before_vs_item',False),
('top_7_impression_counter_max_after_vs_item',False),
('clickout_counter_vs_impression_counter_rank_after',False),
('impression_counter_min_before',False),
('interaction_counter_prev_1_vs_item',False),
('clickout_counter_vs_interaction_counter_prev_2_vs_item',False),
('top_7_impression_counter_prev_2_vs_item',False),
('interaction_counter_prev_3_vs_item',False),
('interaction_counter_vs_impression_counter_max_after_vs_item',False),
('identifier_counter_rank_norm',False),
('clickout_counter_vs_impression_counter_mean_prev_3_vs_item',False),
('identifier_counter_rank_norm_before',False),
('interaction_counter_prev_2_vs_item',False),
('identifier_counter_rank',False),
('clickout_counter_vs_interaction_counter_min_prev_3_vs_item',False),
('identifier_counter_rank_before',False),
('clickout_counter_next_2_vs_item',False),
('interaction_counter_vs_impression_counter_min_prev_3_vs_item',False),
('top_7_impression_counter_min_before',False),
('clickout_counter_vs_interaction_counter_max',False),
('interaction_counter_vs_impression_counter_min_after_vs_item',False),
('clickout_counter_vs_impression_counter_min_after_vs_item',False),
