...
numerical_features_info = [
    ...
    #time rank features
    ("diff_num",False),
    ("rank_diffs_mean", False),
    ("time_diff_mean",False),
    ("time_vs_rank_mean",False),
    ("rank_diffs_min",False),
    ("time_diff_min",False),
    ("time_vs_rank_min",False),
    ("rank_diffs_max",False),
    ("time_diff_max",False),
    ("time_vs_rank_max",False),
    ("rank_diffs_mean_5",False),
    ("time_diff_mean_5",False),
    ("time_vs_rank_mean_5",False),
    ("rank_diffs_min_5",False),
    ("time_diff_min_5",False),
    ("time_vs_rank_min_5",False),
    ("rank_diffs_max_5",False),
    ("time_diff_max_5",False),
    ("time_vs_rank_max_5",False),
    ("estimated_move",False),

    #price features
    ("impressions_pos",False),
    ("impressions_pos_norm",False),
    ("item_price",False),
    ("mean_price",False),
    ("mean_price_vs_item_price",False),
    ("min_price_vs_item_price",False),
    ("max_price_vs_item_price",False),
    ("price_rank",False),
    ("price_rank_norm",False),
    ("mean_price_before",False),
    ("mean_price_before_vs_item_price",False),
    ("min_price_before",False),
    ("min_price_before_vs_item_price",False),
    ("max_price_before",False),
    ("max_price_before_vs_item_price",False),
    ("mean_price_after",False),
    ("mean_price_after_vs_item_price",False),
    ("min_price_after",False),
    ("min_price_after_vs_item_price",False),
    ("max_price_after",False),
    ("max_price_after_vs_item_price",False),
    ("price_rank_before",False),
    ("price_rank_norm_before",False),
    ("price_rank_after",False),
    ("price_rank_norm_after",False),
    ("min_price_first3_vs_item_price",False),
    ("max_price_first3_vs_item_price",False),
    ("mean_price_first3_vs_item_price",False),
    ("price_vs_price_prev_3",False),
    ("price_vs_price_prev_2",False),
    ("price_vs_price_prev_1",False),
    ("price_vs_price_next_1",False),
    ("price_vs_price_next_2",False),
    ("min_price_previous3_vs_item_price",False),
    ("max_price_previous3_vs_item_price",False),
    ("mean_price_previous3_vs_item_price",False),

    # compv1
    ("clickout_counter_vs_verified_impression_counter_max_before_vs_item",False),
    ("conditional_mean_rank_counter_mean_before_vs_item",False),
    ("conditional_mean_rank_counter_rank_norm_before",False),
    ("interaction_counter_vs_verified_impression_counter_mean_before",False),
    ("interaction_counter_vs_verified_impression_counter_mean_after",False),
    ("interaction_counter_vs_verified_impression_counter_rank_before",False),
    ("interaction_counter_vs_verified_impression_counter_prev_2_vs_item",False),
    ("specific_impression_counter_interaction item deals_vs_verified_impression_counter_rank_norm_before",False),
    ("specific_impression_counter_interaction item info_mean_vs_item",False),
    ("top_3_impression_counter_mean_before",False),
    ("top_3_impression_counter_max_before",False),
    ("top_3_impression_counter_vs_impression_counter_mean_vs_item",False),
    ("top_5_impression_counter_mean_vs_item",False),
    ("top_5_impression_counter_vs_impression_counter_next_1_vs_item",False),
    ("top_7_impression_counter_vs_impression_counter_mean",False),
    ("verified_impression_counter_mean",False),
    ("verified_impression_counter_vs_impression_counter_mean_after",False),
    ("verified_impression_counter_vs_impression_counter_max_after_vs_item",False),
    ("verified_impression_counter_vs_impression_counter_rank_before",False),
    ("clickout_counter_mean_before",False),
    ("clickout_counter_vs_impression_counter_mean_before_vs_item",False),
    ("clickout_counter_vs_interaction_counter_rank",False),
    ("clickout_counter_vs_interaction_counter_mean_before",False),
    ("identifier_counter_mean_vs_item",False),
    ("identifier_counter_mean_first_3_vs_item",False),
    ("identifier_counter_prev_3_vs_item",False),
    ("identifier_counter_prev_1_vs_item",False),
    ("impression_counter_mean_first_3_vs_item",False),
    ("interaction_counter_pure",False),
    ("interaction_counter_max",False),
    ("interaction_counter_rank_norm",False),
    ("interaction_counter_mean_before_vs_item",False),
    ("interaction_counter_vs_impression_counter_max_first_3_vs_item",False),
    ("mean_rank_counter_mean_before",False),
    ("mean_rank_counter_min_before_vs_item",False),
    ("mean_rank_counter_max_after",False),
    ("mean_rank_counter_prev_3_vs_item",False),
    ("mean_rank_counter_prev_2_vs_item",False),
    ("top_7_impression_counter_rank_before",False),
