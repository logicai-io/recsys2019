...
numerical_features_info = [
    ...
    ("clickout_item_clicks_by_platform_device_city", False),
    ("clickout_item_impressions_by_platform_device_city", False),
    ("clickout_item_ctr_by_platform_device_city", False),
    ("clickout_item_ctr_corr_by_platform_device_city", False),
    ...
    ("clickout_item_clicks_by_city", False),
    ("clickout_item_impressions_by_city", False),
    ("clickout_item_ctr_by_city", False),
    ("interact_item_clicks", False),
    ("interact_item_impressions", False),
    ("interact_item_ctr", False),
    ("interact_item_clicks_by_platform_device_city", False),
    ("interact_item_impressions_by_platform_device_city", False),
    ("interact_item_ctr_by_platform_device_city", False),
    ...
    ("interact_item_clicks_by_city", False),
    ("interact_item_impressions_by_city", False),
    ("interact_item_ctr_by_city", False),
